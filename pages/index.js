  ...
  return (
    <>
      ...
      <div>
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="pt-6">
            ...
            <h2 className="prose pt-5 text-lg text-gray-600 dark:text-gray-300">
              {`Welcome to ${siteMetadata.description}. I am a Software Engineer who is passionate about building scalable software solutions and distributed systems. In my free time, I like developing `}
              side projects and learning new technologies.
            </h2>
            <p className="pt-5 text-lg leading-7 text-slate-600 dark:text-slate-300 sm:block md:hidden lg:hidden">
              Welcome to my corner of the web—where I document{' '}
              <RoughNotation
                animate={true}
                type="highlight"
                show={true}
              ...
              , share my projects, and reflect on everything I'm learning.
            </p>
            ...
            <div className="grid grid-cols-1 grid-rows-4 gap-8 py-12">
              <div className="my-2 grid items-start gap-8">
                <div className="group relative">
                  <div className="animate-tilt absolute -inset-0.5 rounded-lg bg-gradient-to-r from-green-600 to-emerald-600 opacity-50 blur transition duration-1000 group-hover:opacity-100 group-hover:duration-200"></div>
                  <Link href="/projects">
              ...
              <div className="my-2 grid items-start gap-8">
                <div className="group relative">
                  <div className="animate-tilt absolute -inset-0.5 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-600 opacity-50 blur transition duration-1000 group-hover:opacity-100 group-hover:duration-200"></div>
                  <Link href="/resume.pdf" target="_blank" rel="noopener noreferrer">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      ...
                      <span className="pl-6 text-blue-400 transition duration-200 group-hover:text-gray-900 dark:group-hover:text-gray-100">
                        Resume&nbsp;&rarr;
                      </span>
                    </span>
                  </Link>
              ...
              <div className="my-2 grid items-start gap-8">
                <div className="group relative">
                  <div className="animate-tilt absolute -inset-0.5 rounded-lg bg-gradient-to-r  from-indigo-600 to-purple-600 opacity-50 blur transition duration-1000 group-hover:opacity-100 group-hover:duration-200"></div>
                  <Link href="/contact">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      <span className="flex items-center space-x-5">
                        <svg
        ...
        <ul>
          {!blogsData.length && 'No articles found.'}
          {blogsData.slice(0, MAX_DISPLAY).map((article) => {
            return (
              <Link
                href={article.href}
                key={article.title}
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex flex-wrap">
                            <span className="text-sm text-gray-500 dark:text-gray-400">
                              {article.tech1} • {article.tech2} • {article.tech3}
                            </span>
                          </div>
